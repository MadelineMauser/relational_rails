...
RSpec.feature "chicken index page", type: :feature do
  it "shows each chicken with a boolean of 'true' and its attributes" do
    ...
    expect(page).to have_content(chicken5.name)
    expect(page).to have_content("Is broody: #{chicken5.is_broody}")

    expect(page).not_to have_content(chicken1.name)
  end
